    ...
    <div className="App">
      ...
      <div className="wrapper">
              ...
              <form className="form">
                ...
                <div className="cat">
                  <img
                    ...
                    width="60px"
                  />
                  <input type="checkbox" value="cat" placeholder="cat"></input>
                  <img
                    src={img_btn_dog}
                    className="btnimg"
                    href="#"
        ...
        <div>
          ...
          <button className="Accordion">
            Требования к собаке-донору крови
          </button>
          <div className="panel">
            <ul>
              <li>Возраст от 1 года до 7 лет</li>
          ...
          <div className="wrapper" id="donor">
            ...
            <div className="wrapper-text">
              Ищете кровь для своего питомца или хотите помочь спасти других
              животных? Мы создали этот сайт, чтобы вы не теряли драгоценное
              время на форумах и в соцсетях
            </div>
          </div>
